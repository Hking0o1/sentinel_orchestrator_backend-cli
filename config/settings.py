...
class Settings(BaseSettings):
    ...
    SCHEDULER_STALL_THRESHOLD_SEC: int = 60
    SCHEDULER_TASK_TIMEOUT_SEC: int = 900
    SCHEDULER_HIGH_FAILURE_RATE_THRESHOLD: float = 0.4
    SCHEDULER_STARVATION_THRESHOLD_SEC: int = 45

    # --- Security Control Layer (Phase 1.7) ---
    SECURITY_DNS_TIMEOUT_SECONDS: float = 2.0
    SECURITY_ENABLE_DOMAIN_VERIFICATION: bool = True
    SECURITY_ENABLE_ABUSE_GUARD: bool = True
    SECURITY_ENABLE_RATE_LIMITING: bool = True
    SECURITY_MAX_SCANS_PER_HOUR: int = 20
    SECURITY_MAX_CONCURRENT_NEW: int = 1
    SECURITY_MAX_CONCURRENT_VERIFIED: int = 3
    SECURITY_MAX_CONCURRENT_TRUSTED: int = 6
    SECURITY_MAX_DEEP_SCANS_PER_DOMAIN_PER_DAY: int = 3
    SECURITY_DOMAIN_COOLDOWN_SECONDS: int = 120
    SECURITY_GLOBAL_ACTIVE_SCAN_CAP: int = 100
